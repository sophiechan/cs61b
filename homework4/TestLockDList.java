  ...
  public static void main (String[] args) {
    ...
    System.out.println("Here is a homework4 after insertBack 6, 9, 12: "
		       + sl1.toString());
    System.out.println();
    ...
    System.out.println("Here is the same homework4 after insertBack(15) and insertFront(3): "
		       + sl1.toString());
    newtest(sl1);
   ...
   *  insertBack() on an empty homework4.  Prints summary information of the tests
  ...
  private static void testEmpty() {
    ...
    System.out.println("Here is a homework4 after insertBack(5) on an empty homework4: "
		       + lst2.toString());
    TestHelper.verify(lst2.toString().equals("[  5  ]"),
		      "insertBack on empty homework4 failed");
  }
  ...
  private static void testAfterInsertFront() {
    ...
    System.out.println("Here is the same homework4 after insertBack(4): "
		       + lst1.toString());
    TestHelper.verify(lst1.toString().equals("[  1  2  3  4  ]"),
		      "insertBack on non-empty homework4 failed");
  }
  ...
  private static void testAfterinsertBack() {
    ...
    System.out.println();
    System.out.println("Here is a homework4 after insertBack 6, 7: "
		       + lst1.toString());
    System.out.println("isEmpty() should be false. It is: " +
		       lst1.isEmpty());
    TestHelper.verify(lst1.isEmpty() == false,
  ...
  private static void newtest(LockDList sl1) {
	  ...
	  System.out.println("After insertBefore(3) and insertAfter(3), The first 3 nodes should be 5,3,8. The homework4 is: " +
			  sl1.toString());
