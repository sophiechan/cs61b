...
/**
 *  A DList is a mutable doubly-linked homework4 ADT.  Its implementation is
...
public class DList {
   ...
   *  size is the number of items in the homework4.  (The sentinel node does not
   *       store an item.)
   *
   ...
   *  Performance:  runs in O(n) time, where n is the length of the homework4.
   */
